...
<form method="post" class="mt-5">
  ...
  <div class="form-group">
    ...
    <select name="category_id" id="category_id" type="text" class="form-control" value="<?php echo esc_html($product->category_id); ?>">
      ...
      <option <?php if ($product->category_id == '1' ) echo 'selected' ; ?> value="1">Elettrodomestici</option>
      <option <?php if ($product->category_id == '2' ) echo 'selected' ; ?> value="2">Gadget</option>
    </select>
  </div>
  <div class="form-group">
